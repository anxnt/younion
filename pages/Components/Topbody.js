...
function Topbody() {
  ...
  return (
    ...
    <>
      ...
      <div className={styles.jaacandswitchc} style={{ width: "100vw", height: "150px", marginTop: "500px", display: "flex", justifyContent: "center", alignItems: "center", backgroundColor: "" }}>

        <div className={styles.jaacandswitch} style={{ width: "750px", height: "100%", backgroundColor: "", display: "flex", alignItems: "center", justifyContent: "space-evenly" }}>
          ...
          <div className={styles.switchandjaacc} style={{ width: "450px", height: "90px", display: "flex", alignItems: "center", justifyContent: "space-between", borderRadius: "75px", background: "rgba(113, 113, 113, 0.20)", backdropFilter: "blur(10.5px)" }}>
